    ...
    for inst_result in result.instances:
        ...
        if size is not None:
            ...
            db.add(Measurement(
                ...
                equatorial_diameter_mm=size.equatorial_diameter_mm,
                polar_length_mm=size.polar_length_mm,
                shape_index=size.shape_index,
                shape_class=size.shape_class,
                estimated_weight_grams=size.estimated_weight_grams,
                mandi_size_grade=size.mandi_size_grade,
